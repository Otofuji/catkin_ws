...
if("TRUE" STREQUAL "TRUE")
  set(exemplos_projeto1_SOURCE_PREFIX /home/borg/catkin_ws/src/robot17/exemplos_projeto1)
  set(exemplos_projeto1_DEVEL_PREFIX /home/borg/catkin_ws/devel)
  ...
  set(exemplos_projeto1_INSTALL_PREFIX /home/borg/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'exemplos_projeto1' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'borg <borg@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'exemplos_projeto1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/borg/catkin_ws/src/robot17/exemplos_projeto1/${idir}'.  Ask the maintainer 'borg <borg@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${exemplos_projeto1_dep}_FOUND)
      find_package(${exemplos_projeto1_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${exemplos_projeto1_dep} REQUIRED ${depend_list})
  endif()
