...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/borg/catkin_ws/src/robotica16/gscam)
  set(gscam_DEVEL_PREFIX /home/borg/catkin_ws/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/borg/catkin_ws/install)
...
if(NOT "/home/borg/catkin_ws/src/robotica16/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/borg/catkin_ws/src/robotica16/gscam/include;/usr/include/gstreamer-1.0;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/borg/catkin_ws/src/robotica16/gscam/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>, Russell Toris <rctoris@wpi.edu>' to fix it.")
    endif()
