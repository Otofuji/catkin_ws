...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4B.pack(_x.leftFront, _x.leftSide, _x.rightFront, _x.rightSide))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.leftFront, _x.leftSide, _x.rightFront, _x.rightSide,) = _struct_4B.unpack(str[start:end])
      return self
