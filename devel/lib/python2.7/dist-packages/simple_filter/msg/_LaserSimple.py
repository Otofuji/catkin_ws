...
float64 west_laser"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4d.pack(_x.north_laser, _x.south_laser, _x.east_laser, _x.west_laser))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.north_laser, _x.south_laser, _x.east_laser, _x.west_laser,) = _struct_4d.unpack(str[start:end])
      return self
